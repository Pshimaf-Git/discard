...
// New creates and returns a new Discard instance that implements the io.Reader and io.Writer interfaces.
// The returned Discard can be used wherever an io.Reader or io.Writer is required, but the actual data or operation should be ignored.
func New() Discard {
	return Discard{}
}
